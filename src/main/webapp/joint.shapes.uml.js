...
swedesigner.client.model.celltypes = {};

swedesigner.client.model.celltypes.ClassDiagramElement = joint.shapes.basic.Generic.extend({
    ...
    defaults: _.defaultsDeep({
        ...
        type: 'swedesigner.client.model.celltypes.ClassDiagramElement',
        ...
        attrs: {
            ...
            '.uml-class-methods-rect': { 'stroke': 'black', 'stroke-width': 0, 'fill': '#eeeeee' , 'expanded': 'false'},
            '.uml-class-divider-rect': {  'stroke': 'black', 'stroke-width': 1, 'fill': 'black'},


            '.uml-class-name-text': {
                'ref': '.uml-class-name-rect', 'ref-y': .5, 'ref-x': .5, 'text-anchor': 'middle', 'y-alignment': 'middle',
                'fill': 'white', 'font-size': 16, 'font-family': 'Roboto'
            },
...
console.log( this.get('attributesexpanded'));
            ...
            rects = [
                { type: 'name', text: this.getClassName() },
                { type: 'attrs', text: this.get('attributesexpanded') ? this.get('attributes') : "Attributes (click to expand)" },
...
swedesigner.client.model.celltypes.ClassDiagramElementView = joint.dia.ElementView.extend({
